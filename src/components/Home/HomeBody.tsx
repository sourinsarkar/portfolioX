                    ...
                    <div className="my-8 flex justify-center items-center xl:justify-start">
                        <ul className="flex items-center">
                            ...
                            <li className="flex items-center mono-font font-semibold text-sm mq-4:text-base xl:text-base p-2 text-primary-color">
                                <p>Download my</p>
                                <a href="/resume/newresume.pdf" download className="flex items-center mx-2 px-4 py-1.5 xl:px-5 4xl:py-2 rounded-full bg-primary-color xl:font-normal text-white gap-1">Resume <ArrowDownTrayIcon stroke="currentColor" stroke-width="0.5" className="h-4 w-4" /> </a>
                            </li>
                        </ul>
                    </div>
